...
def mock_swapi_client():
    ...
    # Sample person data
    mock.get_person = AsyncMock(return_value={
        "id": 1,
        "name": "Luke Skywalker",
        "height": "172",
        "mass": "77",
    ...
    # Sample film data
    mock.get_film = AsyncMock(return_value={
        "id": 1,
        "title": "A New Hope",
        "episode_id": 4,
    ...
    mock.get_all_films = AsyncMock(return_value=[
        {
            "id": 1,
            "title": "A New Hope",
            "episode_id": 4,
    ...
    # Sample planet data
    mock.get_planet = AsyncMock(return_value={
        "id": 1,
        "name": "Tatooine",
        "rotation_period": "23",
        "orbital_period": "304",
    ...
    mock.get_all_planets = AsyncMock(return_value=[
        {
            "id": 1,
            "name": "Tatooine",
            "diameter": "10465",
    ...
    mock.get_all_starships = AsyncMock(return_value=[
        {
            "id": 12,
            "name": "X-wing",
            "model": "T-65 X-wing",
